...
Review Loop owns read-only reviewer execution and one automatic fresh host-model fallback. Callers may supply review policy and an exact model; risk translation and workflow actions remain caller-owned. See [the canonical product boundary](docs/product-boundary.md).
